module GreenhouseIo
  class Client
    ...
    PERMITTED_OPTIONS = [:page, :per_page, :job_id, :created_after, :updated_after]
    ...
    def custom_fields(id = nil, options = {})
      get_from_harvest_api "/custom_fields#{path_id(id)}", options
    end
